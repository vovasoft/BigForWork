package com.vova.demo_kafka_redis;
...
public class RedisUtils {
    ...
    public Boolean setnx(final String key, final String value) {
        ...
        byte values[] = serializer.serialize(value);
    	    return redisTemplate.getConnectionFactory().getConnection().setNX(keys, values);
    }
    /**
    ...
    public void setex(final String key,final Long timeout,final String value) {
 	    ...
 	    byte keys[] = serializer.serialize(key);
        byte values[] = serializer.serialize(value);
        redisTemplate.getConnectionFactory().getConnection().setEx(keys,timeout ,values);
    }
